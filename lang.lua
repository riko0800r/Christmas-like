...
local db = {
    ["pt-br"] = {
        ...
        ["item_vit"] = "Vitalidade",
        ["item_vit_desc"] = "Regenera vida ao longo do tempo!",
        ["item_vit_stat"] = "Nível %d | Cura: %.1f -> %.1f | A cada %.1fs -> %.1fs",
    ...
    ["en"] = {
        ...
        ["item_vit"] = "Vitality",
        ["item_vit_desc"] = "Regenerates health over time!",
        ["item_vit_stat"] = "Level %d | Heal: %.1f -> %.1f | Every %.1fs -> %.1fs",
